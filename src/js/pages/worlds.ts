...
async function reviewReference(referenceId: string): Promise<void> {
  ...
  App.showModal(`<div class="modal-title">Review metadata</div>
    ...
    <div class="modal-actions">
      <button class="btn btn-secondary" data-action="reclassify-reference" data-args="${escHtml(JSON.stringify([asset.id]))}">Reclassify</button>
      <button class="btn btn-primary" data-action="accept-reference" data-args="${escHtml(JSON.stringify([asset.id]))}">Accept as-is</button>
    </div>`);
}
